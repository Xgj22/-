<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="user in addressInfo" :key="user.id">
        ...
        <p @click="changeDefault(user)">
          ...
          <span class="s3">{{ user.fullAddress }}</span>
        </p>
        <br><br>
      </div>
      <div class="line"></div>
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(shop,index) in detailArrayList" :key="index">
          <li>
            <img :src="shop.imgUrl" :style="{height:100+'px',width:100+'px'}">
          </li>
          <li>
            <p>
              {{ shop.skuName }}
          ...
          <li>
            <h3>￥{{ shop.orderPrice*shop.skuNum }}.00</h3>
          </li>
          <li>X{{ shop.skuNum }}</li>
          <li>有货</li>
        </ul>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        电话：<span>{{ checkedUser.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods:{
    ...
    async sumbitOrder(){
      ...
      try {
        let result = await this.$API.reqSumbitOrder(tradeNo,params)
