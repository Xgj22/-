      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" @change="changeSkuNum(skuNum)" v-model="skuNum">
...
<script>
  ...
  export default {
    ...
    methods:{
      changeChecked(saleAttrValue, saleAttr_spuSaleAttrValueList){
        saleAttr_spuSaleAttrValueList.forEach(element => {
          element.isChecked = 0
        });
      ...
      changeSkuNum(skuNum){
        let judge = skuNum*1
        if(judge.toString()==='NaN'||skuNum<1){
          alert("不合法重新输入")
          this.skuNum = 1
        }else{
          this.skuNum = skuNum
