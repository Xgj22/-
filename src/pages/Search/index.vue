      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-for="(p,index) in this.searchParams.props" :key="index">{{p.split(":")[1]}}<i @click="removeProps(index)">×</i></li>
          </ul>
        </div>
        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:this.searchParams.order.indexOf('1')!=-1}" @click="changeOrder('1')">
                  <a href="#" >综合
                    <span v-show="this.searchParams.order.indexOf('1:asc')!=-1">↑</span>
                    <span v-show="this.searchParams.order.indexOf('1:desc')!=-1" >↓</span>
                  </a>
                </li>
                <li :class="{active:this.searchParams.order.indexOf('2')!=-1}" @click="changeOrder('2')">
                  <a href="#">价格
                    <span v-show="this.searchParams.order.indexOf('2:asc')!=-1">↑</span>
                    <span v-show="this.searchParams.order.indexOf('2:desc')!=-1" >↓</span>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="g in goodsList" :key="g.id">
                <div class="list-wrap">
                  ...
                  <div class="commit">
                    <i class="command">已有<span>{{ g.hotScore }}</span>人评价</i>
                  </div>
                  <div class="operate">
          ...
          <Pagination :pageNo="this.searchParams.pageNo" 
...
export default {
    ...
    methods:{
      ...
      changeOrder(flag){
        ...
        if(flag===orginFlag){
          this.searchParams.order = `${orginFlag}:${orginSortType==='desc'?'asc':'desc'}`
        }else{
          this.searchParams.order = `${flag}:${orginSortType==='desc'?'asc':'desc'}`
        }
        this.getData()
      },
      //自定义事件，获取页数
